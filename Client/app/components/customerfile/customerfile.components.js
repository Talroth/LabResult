...
CustomerfileComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        selector: 'customerFile',
        templateUrl: 'customerFile.components.html'
    }),
    __metadata("design:paramtypes", [loadFiles_services_1.LoadFile])
], CustomerfileComponent);
exports.CustomerfileComponent = CustomerfileComponent;
//# sourceMappingURL=customerfile.components.js.map